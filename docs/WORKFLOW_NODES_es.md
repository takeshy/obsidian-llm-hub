...
Puedes usar modelos CLI (`antigravity-cli`, `claude-cli`, `codex-cli`) en workflows si el CLI esta configurado en los ajustes del plugin. Los modelos CLI son utiles para acceder a modelos insignia sin costos de API.
