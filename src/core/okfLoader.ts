...
export interface OkfBundle {
  ...
  name: string;
  /** True for the generated LLM Hub help bundle shipped with the plugin. */
  builtin?: boolean;
}
...
/** Build the bundled product knowledge prompt shipped with LLM Hub. */
...
export async function readOkfDocument(app: App, root: string | null, bundleId: string, path: string): Promise<OkfDocument | null> {
