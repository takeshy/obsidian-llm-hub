...
export const en = {
  ...
  "dashboard.baseViewHint": "Choose a view stored in this Base. Change its layout with View type below.",
  ...
  "dashboard.baseDateRelativeHint": "Choose minus for the past or plus for the future.",
