...
export const en = {
  ...
  "settings.hybridKeywordWeight": "Hybrid keyword weight",
  "settings.hybridKeywordWeight.desc": "Blend keyword matching with vector similarity (0.0 = vector only, 1.0 = keyword only). Improves retrieval of exact terms like proper nouns and technical jargon",
  "settings.contextExpansion": "Context expansion",
  "settings.contextExpansion.desc": "Number of surrounding chunks to include alongside each matched chunk (0 = matched chunk only). Helps preserve context that would otherwise be cut at chunk boundaries",
  "settings.overFetchExtra": "Over-fetch extra",
  "settings.overFetchExtra.desc": "Additional candidates to retrieve beyond the chunk limit, then trim to the limit (0 = disabled). Increases recall when combined with score threshold filtering",
