...
export const ja: Record<string, string> = {
  ...
  "dashboard.baseViewHint": "このBaseに保存されているビューを選びます。表示形式は下の「ビュー種別」で変更できます。",
  ...
  "dashboard.baseDateRelativeHint": "過去は−、未来は＋を選択します。",
