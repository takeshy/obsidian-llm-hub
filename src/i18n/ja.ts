...
export const ja: Record<string, string> = {
  ...
  "settings.hybridKeywordWeight": "ハイブリッドキーワード重み",
  "settings.hybridKeywordWeight.desc": "キーワード一致をベクトル類似度に混合する割合（0.0 = ベクトルのみ、1.0 = キーワードのみ）。固有名詞や専門用語の検索精度を向上",
  "settings.contextExpansion": "コンテキスト拡張",
  "settings.contextExpansion.desc": "マッチしたチャンクの前後に含める隣接チャンク数（0 = マッチしたチャンクのみ）。チャンク境界で途切れる文脈を補完",
  "settings.overFetchExtra": "追加取得件数",
  "settings.overFetchExtra.desc": "取得チャンク上限に加えて追加取得する候補数。上限に絞り込むことで精度向上（0 = 無効）",
