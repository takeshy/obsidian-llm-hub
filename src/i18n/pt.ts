...
export const pt: Record<string, string> = {
  ...
  "settings.cliPathModal.windowsNote": "Deixe vazio para deteccao automatica (instalacao npm-global ou wrapper no PATH). Para sobrescrever, aponte para uma destas opcoes:\n• `...\\npm\\node_modules\\@google\\gemini-cli\\dist\\index.js` — executado via node (mais seguro)\n• `...\\claude.exe` — executavel standalone\n• `...\\npm\\gemini.cmd` — executado via cmd.exe (metacaracteres no prompt podem causar mau funcionamento)",
